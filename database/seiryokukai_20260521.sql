...
--
-- Host: localhost:8889
-- Creato il: Mag 21, 2026 alle 11:04
...
CREATE TABLE `iscrizioni` (
  ...
  `stato_iscrizione` varchar(1) DEFAULT NULL COMMENT 'A=attivo\nS=sospeso\nC=concluso',
...
CREATE TABLE `iscrizioni_has_corsi` (
  ...
  `stato_iscrizione_corso` varchar(1) DEFAULT NULL COMMENT 'A=attivo\nS=sospeso\nC=concluso',
  `note_iscrizione_corso` longtext
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
--
ALTER TABLE `pagamenti`
  ADD CONSTRAINT `fk_pagamenti_atleti1` FOREIGN KEY (`idatleta`) REFERENCES `atleti` (`idatleta`),
...
--
ALTER TABLE `presenze`
  ADD CONSTRAINT `fk_presenze_iscrizioni_has_corsi1` FOREIGN KEY (`idiscrizione`,`idcorso`) REFERENCES `iscrizioni_has_corsi` (`idiscrizione`, `idcorso`);

--
-- Limiti per la tabella `qualifiche`
--
ALTER TABLE `qualifiche`
  ADD CONSTRAINT `fk_qualifiche_atleti1` FOREIGN KEY (`idatleta`) REFERENCES `atleti` (`idatleta`),
